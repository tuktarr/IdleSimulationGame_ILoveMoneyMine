...
{
    { EMineType::Copper, "구리", Color::Brown, 100, 100, 20, 0.1f},
    ...
    { EMineType::Diamond, "다이아", Color::Cyan, 7000, 30000, 2000, 1.7f},
    { EMineType::Trophy, "전설의 트로피", Color::White, 0, 100000000, 0, 2.5f}
};
